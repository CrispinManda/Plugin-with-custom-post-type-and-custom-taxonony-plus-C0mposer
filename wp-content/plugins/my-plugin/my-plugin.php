...
Plugin URI: http://Crisplugin.com/plugin
...
if ( !class_exists( 'AlecadddPlugin' ) ) {
	...
	class AlecadddPlugin
	{
		...
		public function add_admin_pages() {
			add_menu_page( 'Alecaddd Plugin', 'Cris', 'manage_options', 'alecaddd_plugin', array( $this, 'admin_index' ), 'dashicons-store', 110 );
		}
		...
		function custom_post_type() {
			...
			register_post_type( 'school', ['public' => true, 'label' => 'Schools'] );
		}
